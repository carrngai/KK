report 50100 "Standard Statement Ext"
{
    WordLayout = './R50100_StandardStatementExt.docx';
    Caption = 'Standard Statement Ext';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(DocNo_DtldCustLedgEntriesCaption; 'Invoice No.')//G008
                {
                }
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(CustLedgEntryHdr; "Integer")
                    {
                        ...
                        dataitem(DtldCustLedgEntries; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            column(PostDate_DtldCustLedgEntries; Format(CustLedgerEntry."Document Date", 0, '<Day,2><Month text,3><Year4>')) //G008
                            {
                            }
                            ...
                            column(DueDate_DtldCustLedgEntries; Format(DueDate, 0, '<Day,2><Month text,3><Year4>'))
                            {
                            }
                    ...
                    dataitem(OverdueVisible; "Integer")
                    {
                        ...
                        dataitem(CustLedgEntry2; "Cust. Ledger Entry")
                        {
                            ...
                            column(PostDate_CustLedgEntry2; Format("Document Date", 0, '<Day,2><Month text,3><Year4>')) //G008
                            {
                            }
                            ...
                            column(DueDate_CustLedgEntry2; Format("Due Date", 0, '<Day,2><Month text,3><Year4>'))
                            {
                            }
                ...
                dataitem(AgingBandVisible; "Integer")
                {
                    ...
                    {
                        DataItemTableView = SORTING(Number) WHERE(Number = FILTER(1 ..));
                        column(AgingDate1; Format(AgingDate[1] + 1, 0, '<Day,2><Month text,3><Year4>'))
                        {
                        }
                        column(AgingDate2; Format(AgingDate[2], 0, '<Day,2><Month text,3><Year4>'))
                        {
                        }
                        column(AgingDate21; Format(AgingDate[2] + 1, 0, '<Day,2><Month text,3><Year4>'))
                        {
                        }
                        column(AgingDate3; Format(AgingDate[3], 0, '<Day,2><Month text,3><Year4>'))
                        {
                        }
                        column(AgingDate31; Format(AgingDate[3] + 1, 0, '<Day,2><Month text,3><Year4>'))
                        {
                        }
                        column(AgingDate4; Format(AgingDate[4], 0, '<Day,2><Month text,3><Year4>'))
                        {
                        }
                        column(AgingBandEndingDate; StrSubstNo(AgedSummaryLbl, format(AgingBandEndingDate, 0, '<Day,2><Month text,3><Year4>'), PeriodLength, SelectStr(DateChoice + 1, DuePostingDateLbl)))
                        {
                        }
                        column(AgingDate41; Format(AgingDate[4] + 1, 0, '<Day,2><Month text,3><Year4>'))
                        {
                        }
                        column(AgingDate5; Format(AgingDate[5], 0, '<Day,2><Month text,3><Year4>'))
                        {
                        }
    ...
    var
        ...
        AgedSummaryLbl: Label 'Aged Summary as on %1', Comment = '%1=Report aging band end date';
        ...
        PostDate_DtldCustLedgEntriesCaptionLbl: Label 'Invoice Date'; //G008
