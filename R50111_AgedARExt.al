report 50111 "Aged Accounts Receivable Ext"
{
    DefaultLayout = RDLC;
    RDLCLayout = './R50111_AgedARExt.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'Aged Accounts Receivable Ext';
            ...
            dataitem(Customer; Customer)
            {
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(TempCustLedgEntryLoop; "Integer")
                    {
                        ...
                        // column(CLEPostingDate; Format(CustLedgEntryEndingDate."Posting Date")) //G010
                        column(CLEPostingDate; Format(CustLedgEntryEndingDate."Document Date")) //G010
                        {
                        }
    ...
    var
        ...
        // CLEEndDatePstngDateCptnLbl: Label 'Posting Date'; //G010
        CLEEndDatePstngDateCptnLbl: Label 'Document Date'; //G010
