table 50109 "Exchange Rate Master"
{
    ...
    var
        ...
        CurrencyExchRate2: array[2] of Record "Exchange Rate Master";
        CurrencyExchRate3: array[3] of Record "Exchange Rate Master";
    ...
    var
        CurrencyExchangeRate: Record "Exchange Rate Master";
    begin
    ...
    local procedure OnAfterFindCurrency(var CurrencyExchangeRate: Record "Exchange Rate Master"; var CurrencyExchangeRateArray: array[2] of Record "Exchange Rate Master")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnExchangeAmtFCYToLCYOnAfterSetRelationalExchRateAmount(var CurrencyExchangeRate: Record "Exchange Rate Master")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnFindCurrencyOnAfterCurrencyExchRate2SetFilters(var CurrencyExchRate2: Record "Exchange Rate Master"; CurrencyCode: Code[10]; Date: Date)
    begin
    end;
