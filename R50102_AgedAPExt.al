report 50102 "Aged Accounts Payable Ext"
{
    DefaultLayout = RDLC;
    RDLCLayout = './R50102_AgedAPExt.rdl';
        ...
        dataitem(Vendor; Vendor)
        {
            ...
            dataitem(CurrencyLoop; "Integer")
            {
                ...
                dataitem(TempVendortLedgEntryLoop; "Integer")
                {
                    ...
                    //column(VendLedgEntryEndDtPostgDt; Format(VendorLedgEntryEndingDate."Posting Date")) //G010
                    column(VendLedgEntryEndDtPostgDt; Format(VendorLedgEntryEndingDate."Document Date")) //G010
                    {
                    }
    ...
    var
        ...
        //PostingDateCaptionLbl: Label 'Posting Date'; //G010
        PostingDateCaptionLbl: Label 'Document Date'; //G010
